        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-6">
              Quality fashion for every occasion, designed with care.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products?category=new" className="text-gray-400 hover:text-white">
                  New Arrivals
                </Link>
              </li>
              <li>
                <Link href="/products?category=bestsellers" className="text-gray-400 hover:text-white">
                  Best Sellers
                </Link>
              </li>
              <li>
                <Link href="/products?category=sale" className="text-gray-400 hover:text-white">
                  Sale
                </Link>
              </li>
            </ul>
      ...
      <div className="bg-black py-6">
        <div className="container-padded">
          <p className="text-gray-400 text-sm text-center">
            &copy; {currentYear} Rashakin. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
