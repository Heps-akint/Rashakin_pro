...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  // Simplify product data access
  const { id, name, images, price, sizes, colors, category } = product;
  ...
  const handleAddToWishlist = (e: React.MouseEvent) => {
    ...
    startTransitionWishlist(async () => {
      try {
        ...
        toast.error(`Error adding ${name} to wishlist. Please try again.`);
      }
    });
  };
          ...
          <div className="mt-1 flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <button 
                ...
                disabled={isPendingWishlist || !user}
              >
